    ...
    public void formSubmitAction() {
        if (birthday.getValue() == null) {
            ...
            Platform.runLater(() -> {
                ...
                DAO.setUserLogs_With_MAC(FXMLLoginController.User_Login, "Update customer " + CustomerID.getText(),
